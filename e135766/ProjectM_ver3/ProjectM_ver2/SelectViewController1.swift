...
class SelectViewController1: UIViewController {
    let myStepLabel1: UILabel = UILabel(frame: CGRectMake(0,0,150,50))
    let myStepLabel2: UILabel = UILabel(frame: CGRectMake(0,0,150,50))
    ...
    override func viewDidLoad() {
        ...
        // Stepperの作成する.
        myStepper1.center = CGPointMake(self.view.frame.width * 3/4, 200)
        ...
        myStepper2.center = CGPointMake(self.view.frame.width * 3/4, 300)
        ...
        // Labelを作成する.
        myStepLabel1.backgroundColor = UIColor.redColor()
        ...
        myStepLabel2.backgroundColor = UIColor.redColor()
        myStepLabel2.layer.masksToBounds = true
        myStepLabel2.layer.cornerRadius = 25.0
        myStepLabel2.textColor = UIColor.whiteColor()
