...
class FirstViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 最小値, 最大値, 規定値の設定をする.
        myStepper1.minimumValue = 0
        myStepper1.maximumValue = 100
        myStepper1.value = 0
        
        myStepper2.minimumValue = 0
        myStepper2.maximumValue = 100
        myStepper2.value = 0
        ...
        myStepLabel1.text = "\(Int(myStepper1.value))"
        
        myStepLabel2.backgroundColor = UIColor.blueColor()
        ...
        myStepLabel2.text = "\(Int(myStepper2.value))"
    ...
    func onClickMyButton(sender: UIButton){
       ...
       // mySecondViewController.modalTransitionStyle = UIModalTransitionStyle.PartialCurl
        ...
        let myRand:Rand = Rand()
        myRand.getrandom(x, yi: y)
        //myRand.getrand(x , y)
