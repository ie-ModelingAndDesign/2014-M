...
class FirstViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let myImage2 = UIImage(named:"title.png")!
        let myImage3 = UIImage(named:"tm.png")!
        ...
        myImageView2.frame = CGRectMake(0, 0, self.view.frame.width - 20, (self.view.frame.width - 20)/2.6)
        myImageView2.layer.position = CGPoint(x: self.view.frame.width/2, y:150)
        myImageView3.frame = CGRectMake(0, 0, myImage.size.width/8, myImage.size.height/20)
        myImageView3.layer.position = CGPoint(x: self.view.bounds.width - (myImage.size.width/16 + 5), y:30)
        //myImageView3.frame = CGRectMake(130, 300, myImage.size.width/3, myImage.size.height/10)
        ...
        //タイトルをつける
        myButton1.setTitle("ランダムセレクト", forState: UIControlState.Normal)
        ...
        // ボタンの位置を指定する.
        myButton1.layer.position = CGPoint(x: self.view.frame.width/2, y:self.view.bounds.height - 150)
        myButton2.layer.position = CGPoint(x: self.view.frame.width/2, y:self.view.bounds.height - 100)
        myButton3.layer.position = CGPoint(x: self.view.frame.width/2, y:self.view.bounds.height - 50)
    }
